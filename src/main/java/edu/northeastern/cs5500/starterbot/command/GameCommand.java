...
public class GameCommand implements SlashCommandHandler, ButtonHandler {
    ...
    private MessageCreateBuilder createStartGameMessageBuilder(
        ...
        if (gameName.equals(BLACKJACK_GAME_NAME)) {
            ...
            imageUrl =
                    "https://en.wikipedia.org/wiki/Glossary_of_blackjack_terms#/media/File:Blackjack21.jpg";
        }
        ...
        return new MessageCreateBuilder().addEmbeds(embedBuilder.build()).addActionRow(join, start);
    }
}
